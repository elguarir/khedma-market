...
const LanguagesForm = (props: LanguagesFormProps) => {
  ...
  let { mutate: removeSkill, isLoading: isRemoving } =
    api.profile.removeSkill.useMutation();
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    if (skillEdit) {
      updateSkill(
        { id: skill.id, level: values.level, name: skill.name },
        {
          onSuccess: () => {
            refresh();
          },
...
//     }
//     addSkill(
//       { name: skill.name, level: values.level },
//       {
//         onSuccess: () => {
//           refresh();
//         },
